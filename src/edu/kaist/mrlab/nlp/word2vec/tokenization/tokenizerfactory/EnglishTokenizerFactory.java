...
import edu.kaist.mrlab.nlp.word2vec.tokenization.tokenizer.EnglishTokenizer;
 ...
 *
 */
public class EnglishTokenizerFactory implements TokenizerFactory {

    private TokenPreProcess preProcess;

    public EnglishTokenizerFactory() {}

    @Override
    public Tokenizer create(String toTokenize) {
        EnglishTokenizer t = new EnglishTokenizer(toTokenize);
